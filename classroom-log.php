                            ...
                            <div class="row row-cols-md-4">
                                ...
                                if (!empty($salas)) {
                                    ...
                                    <div class="col" style="width: 20rem;">
                                        <div class="card" style="width: 18.5rem; padding: 5px 10px;">
                                            <div class="card-detals">
                                                <div class="cube"></div>
                                            </div>
                                            <div class="card-body">
                                                <h2><i class="bx bx-play"></i></h2>
                                                ...
                                                <div class="row d-flex justify-content-between">
                                                    <div class="col">
                                                        ...
                                                        <h6> <strong>Questoes:</strong></h6>
                                                    </div>
                                                    <div class="col">
                                                        <h6>' . $sala['chave'] . '</h6>
                                                        <h6>' . $sala['professor'] . '</h6>
                                                        <h6>' . date('d/m/Y', strtotime($sala['dates'])) . '</h6>        
                                                        <h6>5/5</h6>                                                   
                                                    </div>
                                                </div>
                                                <div class="button">
                                                    <a href="history?sala=' . $sala['idHistory'] . '" class="btn btn-primary">Visualizar</a>
                                                </div>
                                            </div>
